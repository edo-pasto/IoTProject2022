...
soilMoistureSensorStop.onclick = (e)=>{
    axios.get("http://localhost:8084/soilMoistureSensor001/stop").then((response)=>{
...
irrigatorStart.onclick = (e)=>{
    axios.get("http://localhost:8080/irrigator002/start").then((response)=>{
        console.log("Starting Irrigator");
    }).catch((error)=>console.error(error));
};
...
//# sourceMappingURL=tutorials.IoT-over-MQTT.8cfc62b9.js.map
